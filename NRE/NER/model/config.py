...
class Config():
    ...
    filename_dev = "./NER/data/CoNLL03valid.txt" # dev
    filename_test = "./NER/data/CoNLL03test.txt" # test
    filename_train = "./NER/data/CoNLL03train.txt" # train
