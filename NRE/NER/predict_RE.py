...
text_path = "./NER/runs/1601652948/checkpoints/../vocab"
print(text_path)
print("====================================================")
text_vocab_processor = tf.contrib.learn.preprocessing.VocabularyProcessor.restore(text_path)
checkpoint_file = tf.train.latest_checkpoint("./NER/runs/1601652948/checkpoints/")
    ...
    with tf.device('/cpu:0'):
        ...
        with graph.as_default():
            ...
            with sess.as_default():
                ...
                prediction = label2class[pred_test[0]]
